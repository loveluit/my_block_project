	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('tag.category') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('author.allpost') }}" class="nav-link">
              <i class="link-icon" data-feather="user"></i>
              <span class="link-title">All Post</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{ route('permission') }}" class="nav-link">
              <i class="link-icon" data-feather="user"></i>
              <span class="link-title">Role_parmission</span>
            </a>
          </li>
      ...
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item active" href="../../../demo_1/dashboard-one.html">
            <img src="{{asset('Back_end')}}/images/screenshots/light.jpg" alt="light theme">
          </a>
          <h6 class="text-muted mb-2">Dark Theme:</h6>
          <a class="theme-item" href="../../../demo_2/dashboard-one.html">
            <img src="{{asset('Back_end')}}/images/screenshots/dark.jpg" alt="light theme">
          </a>
        </div>
      </div>
    </nav>
                    ...
                    @endif
								...
								<div class="dropdown-body">
									<ul class="profile-nav p-0 pt-3">
										...
										<li class="nav-item">
											<a href="{{ route('edite.profile') }}" class="nav-link">
