...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" sizes="16x16" href="{{ asset('Font_end') }}/assets/img/favicon.png">
    ...
    <link rel="stylesheet" href="{{ asset('Font_end') }}/assets/css/owl.carousel.css">
    <link rel="stylesheet" href="{{ asset('Font_end') }}/assets/css/line-awesome.min.css">
    <link rel="stylesheet" href="{{ asset('Font_end') }}/assets/css/fontawesome.css">

    <!-- main style -->
    <link rel="stylesheet" href="{{ asset('Font_end') }}/assets/css/style.css">
    <link rel="stylesheet" href="{{ asset('Font_end') }}/assets/css/custom.css">
</head>
...
<body>
            ...
            <div class="header-area ">
                ...
                <div class="logo">
                    <a href="{{ route('index.page') }}">
                        <img src="{{ asset('Font_end') }}/assets/img/logo/logo-dark.png" alt=""
                            class="logo-dark">
                        <img src="{{ asset('Font_end') }}/assets/img/logo/logo-white.png" alt=""
                            class="logo-white">
                    </a>
                </div>
                <div class="header-navbar">
                    <nav class="navbar">
                        ...
                        <div class="collapse navbar-collapse" id="main_nav">
                            <ul class="navbar-nav ">
                                <li class="nav-item ">
                                    <a class="nav-link active" href="{{ route('index.page') }}"> Home </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('authors.list') }}"> Authors </a>
                                </li>
                                <li class="nav-item">
    ...
    <!-- JS Plugins  -->
    <script src="{{ asset('Font_end') }}/assets/js/theia-sticky-sidebar.js"></script>
    <script src="{{ asset('Font_end') }}/assets/js/ajax-contact.js"></script>
    <script src="{{ asset('Font_end') }}/assets/js/owl.carousel.min.js"></script>
    <script src="{{ asset('Font_end') }}/assets/js/switch.js"></script>
    <script src="{{ asset('Font_end') }}/assets/js/jquery.marquee.js"></script>
