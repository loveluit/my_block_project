                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading-2-title text-left">
                            ...
                            <p class="desc">{{ $search_poosts->count() }}  :Articles were found for keyword  <strong>  {{ @$_GET['keyword'] }}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 oredoo-content">
                    <div class="theiaStickySidebar">
                     <!--Post1-->
                     @foreach ($search_poosts as $search )


                    <div class="post-list post-list-style1 pt-0">
                        <div class="post-list-image">
                            <a href="post-single.html">
                                <img src="{{ asset('uploads/post/priview') }}/{{ $search->priview }}" alt="">
                            </a>
                        </div>
